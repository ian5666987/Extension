...
namespace Extension.Database.Oracle {
  ...
  public class OracleHandler {
    ...
    public static bool TryGetSingleCell(OracleConnection conn, string selectSqlQuery, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(OracleConnection conn, string selectSqlQuery, OracleParameter par, out object result) {
      return tryGetSingleCell(conn, selectSqlQuery, new List<OracleParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(OracleConnection conn, string selectSqlQuery, IEnumerable<OracleParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, OracleParameter par, out object result) {
      return tryGetSingleCell(connectionString, selectSqlQuery, new List<OracleParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<OracleParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(OracleConnection conn, string selectSqlQuery, IEnumerable<OracleParameter> pars, out object result) {
      result = null;
      try {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<OracleParameter> pars, out object result) {
      bool tryResult;
      using (OracleConnection conn = new OracleConnection(connectionString)) {
        conn.Open();
