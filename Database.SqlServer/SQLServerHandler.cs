...
namespace Extension.Database.SqlServer {
  ...
  public class SQLServerHandler {
    ...
    public static bool TryGetSingleCell(SqlConnection conn, string selectSqlQuery, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(SqlConnection conn, string selectSqlQuery, SqlParameter par, out object result) {
      return tryGetSingleCell(conn, selectSqlQuery, new List<SqlParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(SqlConnection conn, string selectSqlQuery, IEnumerable<SqlParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, SqlParameter par, out object result) {
      return tryGetSingleCell(connectionString, selectSqlQuery, new List<SqlParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<SqlParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(SqlConnection conn, string selectSqlQuery, IEnumerable<SqlParameter> pars, out object result) {
      result = null;
      try {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<SqlParameter> pars, out object result) {
      bool tryResult;
      using (SqlConnection conn = new SqlConnection(connectionString)) {
        conn.Open();
