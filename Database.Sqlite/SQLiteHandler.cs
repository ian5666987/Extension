...
namespace Extension.Database.Sqlite
{
  ...
  public class SQLiteHandler {
    ...
    public static bool TryGetSingleCell(SQLiteConnection conn, string selectSqlQuery, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(SQLiteConnection conn, string selectSqlQuery, SQLiteParameter par, out object result) {
      return tryGetSingleCell(conn, selectSqlQuery, new List<SQLiteParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(SQLiteConnection conn, string selectSqlQuery, IEnumerable<SQLiteParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, SQLiteParameter par, out object result) {
      return tryGetSingleCell(connectionString, selectSqlQuery, new List<SQLiteParameter> { par }, out result);
    }
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    public static bool TryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<SQLiteParameter> pars, out object result) {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(SQLiteConnection conn, string selectSqlQuery, IEnumerable<SQLiteParameter> pars, out object result) {
      result = null;
      try {
    ...
    /// <param name="result">the resulting single <see cref="object"/> from the execution.</param>
    /// <returns>The checking result</returns>
    private static bool tryGetSingleCell(string connectionString, string selectSqlQuery, IEnumerable<SQLiteParameter> pars, out object result) {
      bool tryResult;
      using (SQLiteConnection conn = new SQLiteConnection(connectionString)) {
        conn.Open();
